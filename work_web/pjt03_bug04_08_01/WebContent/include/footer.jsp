...
<script defer>
      ...
      <form id="prefer-form" method="POST" action="">
        ...
        $sido.addEventListener('change', function () {
          document
            ...
            .setAttribute('value', $sido.options[$sido.selectedIndex].text);
        ...
        $gugun.addEventListener('change', function () {
          document
            ...
            .setAttribute('value', $gugun.options[$gugun.selectedIndex].text);
          if (this[this.selectedIndex].value) {
        ...
        $dong.addEventListener('change', function () {
            ...
            .setAttribute('value', $dong.options[$dong.selectedIndex].text);
        });
      ...
      <c:if test='${userinfo ne null}'>
        $info.addEventListener('click', openInfoModal); $prefer.addEventListener('click',
        openPreferModal);
      </c:if>;
