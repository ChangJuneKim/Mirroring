...
<body>
	...
	<section id="estate" class="section">
		<header class="section__header">
			...
			<div style="border-top: 2px solid black; width: 300px; margin: auto;"></div>
		</header>

		<div class="estate">
			<div class="estate__card apt">
				<img class="estate__icon" src="./images/apt_1.svg" alt="" />
			...
			<div class="estate__card apt2">
				<img class="estate__icon" src="./images/apt_2.svg" alt="" />
				<h2 class="estate__title _2">아파트</h2>
				<p class="estate__text">
					4인 가구라면 <br /> 아파트를 추천드립니다.
				</p>
			</div>
			<div class="estate__card land">
				<img class="estate__icon" src="./images/land_1.svg" alt="" />
