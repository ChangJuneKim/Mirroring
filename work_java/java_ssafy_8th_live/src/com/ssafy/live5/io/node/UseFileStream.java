...
public class UseFileStream {
    ...
    private void testFile() throws IOException {
        ...
        // 상대경로 
        File current = new File("."); // .은 자바를 실행시킨 위치
        ...
        //  프로젝트와 무관하게 파일을 찾을 때 - 절대경로를 사용
        File readMe = new File("C:\\SSAFY\\workspace\\work_java\\java_ssafy_8th_live\\src\\com\\ssafy\\live5\\io\\node\\readme.txt");
