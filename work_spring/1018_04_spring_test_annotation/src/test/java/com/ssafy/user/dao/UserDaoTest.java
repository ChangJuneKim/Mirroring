...
@RunWith(SpringRunner.class)  // 스프링 테스트 컨텍스트 프레임워크의 JUnit 확장기능 지정
...
public class UserDaoTest {
	...
	@org.junit.Before  // JUnit이 제공하는 Annotation. @Test 메서드가 실행되기 전에 먼저 실행되어야 하는 메서드를 정의
	public void setUp() {
	...
	public void addAndGet() throws SQLException {  // JUnit 테스트 메서드는 반드시 public void로 선언

		// 매 테스트 할 때, 동일한 테스트를 수행하면 동일한 결과를 얻어야 한다.
		// 아래와 같은 코드를 추가를 했습니다. (TDD: Test Driven Development)
		dao.deleteAll();
	...
	/*
	 * 기능 설계, 코드 구현, 테스트 세 가지 작업이 동시에 할 수 있다.
	 * 
